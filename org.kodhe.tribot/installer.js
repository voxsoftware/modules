...
async function load(){
	var stdpath= await import("https://kwx.kodhe.com/x/v/0.4.5/std/dist/stdlib")
	kawix.KModule.addVirtualFile("@kawix/std", {
		redirect: stdpath.dirname,
		isdirectory: true
	})
	var gixpath= await import("https://kwx.kodhe.com/x/v/0.4.5/gix/dist/gix")
	kawix.KModule.addVirtualFile("@kawix/gix", {
		redirect: gixpath.dirname,
		isdirectory: true
	})
	var dhspath= await import("https://kwx.kodhe.com/x/v/0.4.5/dhs/dist/dhs")
	kawix.KModule.addVirtualFile("@kawix/dhs", {
		redirect: gixpath.dirname,
		isdirectory: true
	})
	var kivipath= await import("https://kwx.kodhe.com/x/v/0.4.5/kivi/dist/kivi")
...
import stdpath1 from 'https://kwx.kodhe.com/x/v/0.4.5/dhs/dist/dhs'
import stdpath2 from 'https://kwx.kodhe.com/x/v/0.4.5/std/dist/stdlib'
import stdpath3 from 'https://kwx.kodhe.com/x/v/0.4.5/gix/dist/gix'
import stdpath4 from 'https://kwx.kodhe.com/x/v/0.4.5/kivi/dist/kivi'
